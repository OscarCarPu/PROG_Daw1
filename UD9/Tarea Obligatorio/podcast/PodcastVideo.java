...
public class PodcastVideo extends Podcast{
  ...
  public PodcastVideo (int id, String titulo, int tipo, int duracion, String periocidad, Autor autor, List<Genero> generos, String formato_video) {
    super(id, titulo, tipo, duracion, periocidad, autor, generos);
    this.formato_video = formato_video;
  }

  public PodcastVideo (String titulo, int tipo, int duracion, String periocidad, Autor autor, List<Genero> generos, String formato_video) {
